...
<body>
  ...
  <div class="items">
    <div class="item">
      <div class="icon">
        <img src="https://indyme.com/wp-content/uploads/2020/11/customer-icon.png" alt="desktop" border="0">
      </div>
    ...
    <div class="item">
      <div class="icon">
        <img src="https://cdn-icons-png.flaticon.com/512/1414/1414309.png" alt="smartphone" border="0">
      </div>
